...
#VelikostObrazkuX=$(( $DelkaNapis * $(( $VelikostTextu + 30 )) / 2 )) # delka obrazky v ose x bude podle velikosti fontu
VelikostObrazkuX=$(( $DelkaNapis * $(( $VelikostTextu / 2  )) )) # delka obrazky v ose x bude podle velikosti fontu
...
#magick -size 330x140 xc:black -font Bookman-DemiItalic -pointsize 24 -fill white -gravity center -draw "text 0,0 '$out'" n5.png
