...
pripony_obrazku = {"webp","png","tif","jpeg","pcx","bmp","gif","tiff","PNG","TIF","JPEG","PCX","BMP","GIF","TIFF"}
...
-- nezjisteno proc, vse ostatni o.k , pokud existuje najde ho ale vzdy na pozici [1] coz je blobost ??? 
